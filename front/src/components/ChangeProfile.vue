...
<div class="changeProfile" align="center" justify="center">
    <v-container v-if="profile">
        ...
        <div class="buttons">
            ...
            <v-btn elevation="2" class="buttonAnnul" light @click="cancelEdit">Annuler</v-btn>
            <v-btn  elevation="2" class="buttonSuppr" @click="deleteProfile=true" light>Supprimer le profil</v-btn>
        </div>
    </v-container> 

    <v-dialog v-model="deleteProfile"></v-dialog>
</div>
</template>
...
export default {
    ...
    methods: {
        ...
        async changeProfileName() {
            const PATCHRequest = ResourcesService.changeProfileName(this.oldPseudo,this.profile.pseudo);
